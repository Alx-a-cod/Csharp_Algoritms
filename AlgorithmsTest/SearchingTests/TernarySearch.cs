...
// Target in first third → returns correct index.
// Target in middle third → returns correct index.
// Target in last third → returns correct index.
...
namespace AlgorithmsTests
{
    public class TernarySearchTests
    {
        ...
        {
            int[] arr = { 1, 2, 3, 4, 5 };
            int idx = TernarySearch.Search(arr, 1);
            Assert.Equal(0, idx);
        }
        ...
        {
            int[] arr = { 1, 2, 3, 4, 5 };
            int idx = TernarySearch.Search(arr, 5);
            Assert.Equal(4, idx);
        }

        [Fact]
        public void TargetInFirstThird_ReturnsCorrectIndex()
        {
            int[] arr = { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
            int idx = TernarySearch.Search(arr, 2);
            Assert.Equal(1, idx);
        }

        [Fact]
        public void TargetInMiddleThird_ReturnsCorrectIndex()
        {
            int[] arr = { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
            int idx = TernarySearch.Search(arr, 5);
            Assert.Equal(4, idx);
        ...
        [Fact]
        public void TargetInLastThird_ReturnsCorrectIndex()
        {
            int[] arr = { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
            int idx = TernarySearch.Search(arr, 8);
            Assert.Equal(7, idx);
        }
        ...
        {
            int[] arr = { 1, 2, 3, 4, 5 };
            int idx = TernarySearch.Search(arr, 10);
            Assert.Equal(-1, idx);
        }
        ...
        {
            int[] arr = { 7, 7, 7, 7 };
            int idx = TernarySearch.Search(arr, 7);
        ...
        {
            int[] arr = { };
            int idx = TernarySearch.Search(arr, 42);
            Assert.Equal(-1, idx);
        }
        ...
        public void ArrayWithNegativesAndPositives_FindsCorrectly()
        {
            ...
            idx = TernarySearch.Search(arr, 10);
            Assert.Equal(4, idx);

            idx = TernarySearch.Search(arr, 0);
            Assert.Equal(2, idx);
        }
        ...
        {
            int[] arr = { -2, 0, 0, 1, 3 };
            int idx = TernarySearch.Search(arr, 0);
