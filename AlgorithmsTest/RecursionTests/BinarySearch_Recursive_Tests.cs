...
{
    public class BinarySearch_Recursive_Tests
    {
        [Fact]
        public void TargetAtBeginning_ReturnsIndexZero()
        {
            int[] arr = { 1, 2, 3, 4, 5 };
            int idx = BinarySearchRecursive.Search(arr, 1);
            Assert.Equal(0, idx);
        }
        ...
        {
            int[] arr = { 1, 2, 3, 4, 5 };
            int idx = BinarySearchRecursive.Search(arr, 5);
            Assert.Equal(4, idx);
        }
        ...
        {
            int[] arr = { 1, 2, 3, 4, 5 };
            int idx = BinarySearchRecursive.Search(arr, 3);
            Assert.Equal(2, idx);
        }
        ...
        {
            int[] arr = { 1, 2, 3, 4, 5 };
            int idx = BinarySearchRecursive.Search(arr, 10);
            Assert.Equal(-1, idx);
        }
        ...
        {
            int[] arr = { 1, 2, 2, 2, 3, 4 };
            int idx = BinarySearchRecursive.Search(arr, 2);
            Assert.InRange(idx, 1, 3); // any valid index of 2
        }
        ...
        {
            int[] arr = { 7, 7, 7, 7 };
            int idx = BinarySearchRecursive.Search(arr, 7);
        ...
        {
            int[] arr = { };
            int idx = BinarySearchRecursive.Search(arr, 42);
            Assert.Equal(-1, idx);
        }
        ...
        public void ArrayWithNegativesAndPositives_FindsCorrectly()
        {
            ...
            idx = BinarySearchRecursive.Search(arr, 10);
            Assert.Equal(4, idx);

            idx = BinarySearchRecursive.Search(arr, 0);
            Assert.Equal(2, idx);
        }
        ...
        {
            int[] arr = { -2, 0, 0, 1, 3 };
            int idx = BinarySearchRecursive.Search(arr, 0);
